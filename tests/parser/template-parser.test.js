...
describe('templateParser', () => {
  describe('parseContext', () => {
    ...
    test('detects unchanged contexts', () => {
    ...
    test('detects attribute contexts', () => {
      expect(parseContext('<div a=').context).toEqual(attributeContext);
      expect(parseContext('<div a =').context).toEqual(attributeContext);
    });

    test('detects a node context when an attribute contains the ">" character', () => {
      expect(parseContext('<div a=">" b=').context).toEqual(nodeContext);
    });
  });

  describe('parseTemplate', () => {
    test('inserts nodeMarkerTags', () => {
    ...
    test('inserts attributeMarkerTags', () => {
    ...
    test('inserts a nodeMarkerTag when an attribute contains the ">" character', () => {
      expect(parseTemplate(html`<div a=">" b=${0}></div>`)).toEqual(
        `<div a=">" b=${nodeMarkerTag}></div>`
      );
    });

    test('throws an Error on incorrect attribute tag usage', () => {
    ...
    test('inserts commentMarkerTags', () => {
      expect(parseTemplate(html`<!--${0}-->`)).toEqual(
        `<!--${commentMarkerTag}-->`
      );
      expect(parseTemplate(html`<div><!--${0}--></div>`)).toEqual(
    ...
    test('inserts correct tags in different part type sequences', () => {
      expect(
  ...
  describe('buildTemplate', () => {
    test('injects a commentNode for node parts', () => {
    ...
    test('the injected commentNode for node parts contains the nodeMarker', () => {
    ...
    test('injects a commentNode in between comment strings', () => {
      expect(
    ...
    test('the injected commentNode for comment parts contains the commentMarker', () => {
      expect(
    ...
    test('does not break on comment-like comment content', () => {
      expect(
        buildTemplate(html`<!--${0}>-->`).content.childNodes.length
      ).toEqual(3);
      expect(
    ...
    test('adds the failMarker attribute to nodes when an attribute contains the ">" character', () => {
      expect(
        buildTemplate(
          html`<div a=">" b=${0}></div>`
    ...
    test('adds the attributeMarker attribute to nodes with a dynamic attribute', () => {
      expect(
        buildTemplate(
          html`<div a=${0}></div>`
    ...
    test('assigns the attributeMarker value to dynamic attributes', () => {
      expect(
        buildTemplate(
          html`<div a=${0}></div>`
